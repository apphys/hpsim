...
//-------------------- another window --------------------
  ...
  Histogram* hist1 = new Histogram(beam.x, beam.loss, beam.num_particle, -0.015, 0.015, red);
  hist1->SetLabelY("x profile");
  Histogram* hist2 = new Histogram(beam.y, beam.loss, beam.num_particle, -0.015, 0.015, green);
  ...
  Histogram* hist3 = new Histogram(beam.phi_r, beam.loss, beam.num_particle, -M_PI/3.0, M_PI, yellow);
  ...
  Histogram* hist4 = new Histogram(beam.w, beam.loss, beam.num_particle, 5, 101, blue); // tank4
