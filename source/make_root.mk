...
PYTHON_LD_FLAGS=-I/usr/lib64/python2.6/config -lpython2.6 -lpthread
#PYTHON_INC_FLAGS=-I/usr/local/include/python2.7 -I/usr/local/lib/python2.7/site-packages/numpy/core/include/numpy
#PYTHON_LD_FLAGS=-L./usr/local/lib/python2.7/config/ -L/usr/local/lib/python2.7/site-packages/numpy/core/lib -lpython2.7 -lnpymath -lpthread 
#PYTHON_LD_FLAGS=/usr/local/lib/python2.7/config/libpython2.7.a
